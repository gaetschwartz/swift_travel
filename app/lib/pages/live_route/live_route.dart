...
final StreamProvider<Position> positionProvider =
    StreamProvider((_) => Geolocator.getPositionStream());
...
class _LiveRoutePageState extends ConsumerState<LiveRoutePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Consumer(builder: (context, ref, _) {
          final controller = ref.watch(liveRouteControllerProvider);
