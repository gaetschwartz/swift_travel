...
import 'package:swift_travel/apis/navigation/france/models/sncf_place.dart';
...
class SncfCompletion with _$SncfCompletion {
  ...
  factory SncfCompletion.fromJson(Map<String, dynamic> json) =>
      _$SncfCompletionFromJson(json);
}
