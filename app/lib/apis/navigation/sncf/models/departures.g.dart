...
_$_SncfStationboard _$_$_SncfStationboardFromJson(Map<String, dynamic> json) {
  return _$_SncfStationboard(
...
Map<String, dynamic> _$_$_SncfStationboardToJson(
        _$_SncfStationboard instance) =>
    <String, dynamic>{
...
_$_SncfError _$_$_SncfErrorFromJson(Map<String, dynamic> json) {
  return _$_SncfError(
    json['id'] as String,
...
Map<String, dynamic> _$_$_SncfErrorToJson(_$_SncfError instance) =>
    <String, dynamic>{
      'id': instance.id,
      'message': instance.message,
    };

_$_SncfDeparture _$_$_SncfDepartureFromJson(Map<String, dynamic> json) {
  return _$_SncfDeparture(
...
Map<String, dynamic> _$_$_SncfDepartureToJson(_$_SncfDeparture instance) =>
    <String, dynamic>{
...
_$_SncfStopPoint _$_$_SncfStopPointFromJson(Map<String, dynamic> json) {
  return _$_SncfStopPoint(
...
Map<String, dynamic> _$_$_SncfStopPointToJson(_$_SncfStopPoint instance) =>
    <String, dynamic>{
      'commercial_modes':
          instance.commercialModes.map((e) => e.toJson()).toList(),
    };

_$_SncfMode _$_$_SncfModeFromJson(Map<String, dynamic> json) {
  return _$_SncfMode(
    json['id'] as String,
    json['name'] as String,
  );
...
Map<String, dynamic> _$_$_SncfModeToJson(_$_SncfMode instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
    };

_$_SncfStopDateTime _$_$_SncfStopDateTimeFromJson(Map<String, dynamic> json) {
  return _$_SncfStopDateTime(
...
Map<String, dynamic> _$_$_SncfStopDateTimeToJson(
        _$_SncfStopDateTime instance) =>
    <String, dynamic>{
...
_$_SncfDispInfo _$_$_SncfDispInfoFromJson(Map<String, dynamic> json) {
  return _$_SncfDispInfo(
    ...
    equipments:
        (json['equipments'] as List<dynamic>).map((e) => e as Object).toList(),
...
Map<String, dynamic> _$_$_SncfDispInfoToJson(_$_SncfDispInfo instance) =>
    <String, dynamic>{
      'code': instance.code,
